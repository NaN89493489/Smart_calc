...
Программа SmartCalc реализована с учетом следующих условий:
...
Предусмотрен специальный режим "калькулятор доходности вкладов" (за образец взяты сайты banki.ru и calcus.ru):
